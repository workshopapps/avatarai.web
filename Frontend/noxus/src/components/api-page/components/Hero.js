...
const Hero = () => {
	return (
		<div className="w-full">
			<div
				style={{
					background: 'linear-gradient(0deg, rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url(/api-page-images/hero.svg)',
			...
			>
				<div className="flex lg:flex-row flex-col lg:items-center lg:justify-between max-w-[1240px] mx-auto py-10 min-h-[660px] justify-center">
					...
					<div className="flex flex-row lg:flex-col gap-3 md:gap-5 lg:gap-0 mt-10 lg:mt-0">
						<div>
						...
						<div>
							<p className="font-bold text-[30px] md:text-[64px] text-[#ffffff]">3 Mil</p>
							{/* <p className="text-[#3BC489] font-bold text-base mb-[32px]">API TRANSACTIONS</p> */}
						</div>
					</div>
				</div>
			</div>
