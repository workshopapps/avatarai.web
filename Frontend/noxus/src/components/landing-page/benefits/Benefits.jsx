...
const Benefits = () => {
  return (
    <div>
      <h2 className="benefits__title-ony"><span className="aiii-ony">Really</span> fast and easy</h2>

      <div className="benefits__description-ony">
        <diV>
        <h3 className="aiiii-ony">Upload Images!</h3>
        ...
        <h3 className="aiiii-ony">Convert images to avatars.</h3>
        ...
        <h3 className="aiiii-ony">Voila! It’s your avatar</h3>
