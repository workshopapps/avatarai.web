...
const ForgotPassword = () => {
  ...
  return (
    <div className='flex flex-col justify-center items-center gap-y-5 mt-10  px-10  h-screen '>
        ...
        <p className='text-xl'>Please enter the email address associated to this account</p>
        </div>
        <div className="flex flex-col w-full md:w-[28rem]">
          ...
          <Button className="w-full md:w-[28rem] bg-purple text-white"><Link to="/CheckEmail">Log in</Link></Button>
