	...
	return (
		...
		>
          ...
          we recommend you to NOT use the site!
				...
				<div>
					<p className="text-lg my-2">Create unlimited number of digital characters daily</p>
					<hr className=" vnc_hr" />
					<p className="text-lg my-2">Unlimited access to change the avatar's hair, cloth, or skin color</p>{' '}
					<hr className=" vnc_hr" />
					<p className="text-lg my-2">
						Create high resolution characters, cartoons and anime profile photos up to 10 times daily
					</p>
					<hr className=" vnc_hr" />
					<p className="text-lg my-2">Access to unlimited specially designed avatars through referrals</p>{' '}
					<hr className=" vnc_hr" />
					<p className="text-lg my-2">
						Access to save or export the AI-generated avatars in a JPG or PNG format at any time
					</p>{' '}
					<hr className=" vnc_hr" />
					<p className="text-lg my-2">
