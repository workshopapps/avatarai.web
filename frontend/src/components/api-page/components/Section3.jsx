        ...
        <div className="max-w-[1240px] mx-auto px-5 flex flex-col justify-center">
          ...
          <div className="flex justify-center">
            <Button
              ...
              className="px-[26px] py-[12px] outline-none normal-case border border-[#8B70E9] rounded-lg bg-[#ffffff] text-[#8B70E9] mt-[49px] barnerBtn"
            >
              View all features
            </Button>
          </div>
          ...
          <div className="grid grid-cols-12 gap-3 md:h-[542px]">
            ...
            <div className="col-span-12 md:col-span-6 h-full relative rounded-lg w-full">
              ...
              <div className="absolute top-[35%] left-0 right-0 flex flex-col justify-center">
                ...
                <div className="flex justify-center">
                  <Button className="text-white px-[26px] py-[12px] outline-none normal-case border border-[#333333] rounded-lg bg-[#333333] text-[#ffffff] mt-[2rem] md:mt-[70px] barnerBtn">
