...
const MobileNav = ({navClose}) => {
  ...
  return (
    <div className="bg-white w-[261px] h-full  fixed top-0 left-0 ">
      <nav className="flex flex-col justify-center  items-start gap-y-10 md:hidden p-10 ">
        <img src={logo} alt="" />
        ...
        <div className=" w-full flex flex-col items-start justify-start gap-y-10 ">
          <Button className="bg-white border-purple-500 text-purple hover:bg-purple  hover:text-white w-full ">
            Log in
          </Button>
