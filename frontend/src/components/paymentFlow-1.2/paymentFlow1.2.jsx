...
function PaymentFlow12(props){
    ...
    return(
        <div className="cbk fixed w-screen h-screen modal-overlay" id='Paymentflow12' data-testid='Paymentflow12'>
            <div className='cbk bg-white modal p-6 rounded-md'>
                ...
                <button className='text-violet-500 mt-5 hidden max-[768px]:inline'  data-testid='cancel-btn' onClick={() => displayModal('none')}><img src='cancel.svg'  className='inline'/>Cancel Payment</button>
            </div>
        </div>
    )
}
