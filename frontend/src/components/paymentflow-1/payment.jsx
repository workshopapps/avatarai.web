...
const Payment = () => {
  ...
  return (
    <div>
      <PaymentFlow11
        display={flow1}
        resetFlow1={resetFlow1}
        resetFlow2={resetFlow2}
      />
      <PaymentFlow12 display={flow2} resetFlow2={resetFlow2} />
      <div
        className="overlay hidden drop"
        onClick={() => {
          dropdown("none", "block");
        }}
      ></div>
        ...
        <div className="dan-payment-left drop">
          ...
          <div id="cbk-drop" className="cbk-drop drop">
            <div className="flex w-full justify-between">
              ...
              >
                Close
                <img className="inline mb-1" src={Close} />
              </button>
            </div>
            <div className="flex w-full justify-between mt-5 mb-10">
              <div>
                ...
                <p>Billed monthly</p>
                <p>
                  Access to create 600 <br /> Avatars
                </p>
              </div>
          ...
          <p className="dan-art">
            4K avatars are 4096x4096. AI can have random results and may include
            artistic nudes, erotic or otherwise shocking images, if you do not
            want that and are sensitive, we recommend you to NOT use this site!
          </p>

          <div className="Dan-total">
            <div
              className="Dan-total-sub"
              class="flex justify-between w-[100%] pt-[5%]"
            >
              <p>Subtotal</p>
              <p class="font-[500] text-[20px]">$14</p>
            </div>
            ...
            <div
              className="Dan-total-today"
              class="flex justify-between w-[100%] pt-[2%]"
            >
              <div>
                <p>Total due today</p>
              </div>
        ...
        <div className="dan-payment-right">
          <div className="dan-mobile">
            ...
            <div className="dan-view-details">
              ...
              >
                View details <img className="inline cbk-rot" src={Close} />
              </button>
            </div>
          </div>
          ...
          <form onSubmit={handleSubmit}>
            <div className="dan-form-top">
              <div className="dan-email">
                ...
                {error && Email.length <= 0 ? (
                  <p class="text-[red] text-[15px] font-[700]">
              ...
              <div className="dan-card-number">
                ...
                {error && CardNumber.length <= 0 ? (
                  <p class="text-[red] text-[15px] font-[700]">
                    Enter the Appropriate Card Number
                  </p>
                ) : (
                  ""
                )}
            ...
            <div className="dan-form-middle">
              ...
              >
                ...
                <input
                  ...
                  id="dan-month"
                />
                {error && Expirationdate.length <= 0 ? (
                  <p class="text-[red] text-[14px] font-[700]">
                    Enter the Appropriate Expiration Date
                  </p>
                ) : (
                  ""
                )}
            ...
            <div className="dan-form-buttom">
              <div className="dan-form-card">
                ...
                <input
                  oncChange={(e) => setCardname(e.target.value)}
                  type="text"
              ...
              <label htmlFor="select" className="COO">
                Country of Origin
              </label>
              <select>
            ...
            <button className="btn" onClick={() => toogleFlow1("block")}>
              Subscribe
            </button>
          </form>
