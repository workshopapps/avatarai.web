...
const Payment = ()=>{
    ...
    const handleSubmit=(e)=>{
        e.preventDefault()
        if(Email.length===0 || CardNumber===0 || Expirationdate===0 || Cvv===0 || Cardname===0){
            setError(true)
        }
            ...
            <div className='dan-payment-container'>
                <div className='dan-payment-left drop'>
                    <div className='dan-basic'>
                        ...
                        <div className='price'>
                        <h1>$14</h1><p>Per Month</p>
                        </div>   
                    </div>
                    <div className='dan-sub'>
                        <h1 class='font-medium'>Basic</h1>
                        
                        <div className='dan-sub-price'class='flex justify-between w-[100%]' >
                        <p>Billed Monthly</p>
                        <p class='font-[500] text-[20px]'>$14</p>
                        </div>
                ...
                <div className='dan-payment-right'>
                    <div className='dan-mobile'>
                        <div className='dan-subscribe'>
                            <p>Subscribe to Basic</p>
                        </div>
                        <div className='dan-price'>
                            <h1>$14</h1>
                            <p>Per Month</p>
                        </div>
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className='dan-form-top'>
                            <div className='dan-email'>
                                <label htmlFor='email'>Email</label>
                                 <input onChange={e=>setEmail(e.target.value)} type='email' placeholder='johndoe@gmail.com' id='dan-email'/>
                               {error &&Email.length<=0 ? <p class='text-[red] text-[15px] font-[700]'>Enter  the Appropriate Email Address</p>: ""}
                            </div>
                           
                            <div className='dan-card-number'>
                                <label htmlFor='cardnumber'>Card Number</label>
                                <input onChange={e=>setcardnumber(e.target.value)} type='text' placeholder='1234 1234 1234 1234' id='dan-cardnumber'/>
                                {error &&CardNumber.length <=0 ?<p class='text-[red] text-[15px] font-[700]'>Enter the Appropriate Card Number</p> : ""}
                            </div>
                        </div>
                        <div className='dan-form-middle'>
                            <div class='flex flex-col items-start' className='dan-middle-each'>
                            <label htmlFor='month'>Expiration Date</label>
                            <input onChange={e=>setexpirationdate(e.target.value)} type='text' placeholder='MM/YY' id='dan-month'/>
                            {error&&Expirationdate.length<=0?<p class='text-[red] text-[14px] font-[700]'>Enter  the Appropriate Expiration Date</p>:""}
                            </div>
                            <div class='flex flex-col items-start'className='dan-middle-each'>
                            <label htmlFor='Cvv'>CVV</label>
                            <input onChange={e=>setcvv (e.target.value)} type='text' placeholder='123' id='Cvv'/>
                            {error&&Cvv.length<=0 ? <p class='text-[red] text-[15px] font-[700]'>Enter  the Appropriate CVV</p>: ""}
                            </div>
                        </div>
                        <div className='dan-form-buttom' >
                            <div className='dan-form-card'>
                            <label>Name on Card</label>
                            <input oncChange={e=>setCardname (e.target.value)} type='text' placeholder='John Doe'/>
                            {error&&Cardname.length<=0 ? <p class='text-[red] text-[15px] font-[700]'>Enter  the Appropriate Name</p>: ""}
                            </div>
                        
                        
                        <label htmlFor='select' className='COO'>Country of Origin</label>
                        <select>
