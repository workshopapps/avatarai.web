  ...
  return (
    <div>
      ...
      <div >
        ...
        <p className="about__image__title-ony">AI Conference 2022</p>
      </div>
      <div>
        <h3 className="about__support__title-ony">Scrutinized and elaborate courses in every AI aspect</h3>
        <p className="about__description-ony">
          Access every course ranging from beginner level to expert level and up
          your game in the web3 space without any hassle. These courses are
          scrutinized by top industry experts and folks who love what we are
          doing. Get in here and discover what works for you.
        </p>
      </div>
      </div>
